/*
    ...
    Source: https://sourcemaking.com/design_patterns/facade/java/1


 */

// 1. Subsystem
@FacadeAnnotation(name = "PointCartesian", clientAccessible = false)
...
// 1. Subsystem
@FacadeAnnotation(name = "PointPolar", clientAccessible = false)
class PointPolar
{
...
@FacadeAnnotation(name = "Point", clientAccessible = false)
class Point
{
...
@FacadeAnnotation(name = "Line", clientAccessible = false)
class Line
{
    private Point o, e;
...
@FacadeAnnotation(name = "CoordinateFacade", clientAccessible = true)
public class CoordinateFacade
{
    @FacadeAnnotation(name = "CoordinateFacade.constructor", clientAccessible = true)
