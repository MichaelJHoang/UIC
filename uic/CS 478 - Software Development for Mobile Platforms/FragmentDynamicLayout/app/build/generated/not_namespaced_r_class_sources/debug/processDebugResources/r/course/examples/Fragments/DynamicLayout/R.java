...
public final class R {
  ...
  public static final class id {
    ...
    public static final int quoteView=0x7f060024;
    public static final int quote_fragment_container=0x7f060025;
    ...
    public static final int tag_unhandled_key_event_manager=0x7f06002c;
    public static final int tag_unhandled_key_listeners=0x7f06002d;
    ...
    public static final int title_fragment_container=0x7f060032;
  ...
  public static final class layout {
    ...
    public static final int quote_fragment=0x7f080010;
    public static final int title_item=0x7f080011;
  }
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha course.examples.Fragments.DynamicLayout:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name course.examples.Fragments.DynamicLayout:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #CoordinatorLayout_keylines course.examples.Fragments.DynamicLayout:keylines}</code></td><td>A reference to an array of integers representing the
     * locations of horizontal keylines in dp from the starting edge.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_statusBarBackground course.examples.Fragments.DynamicLayout:statusBarBackground}</code></td><td>Drawable to display behind the status bar when the view is set to draw behind it.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name course.examples.Fragments.DynamicLayout:keylines
     */
     ...
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name course.examples.Fragments.DynamicLayout:statusBarBackground
     */
     ...
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchor course.examples.Fragments.DynamicLayout:layout_anchor}</code></td><td>The id of an anchor view that this view should position relative to.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchorGravity course.examples.Fragments.DynamicLayout:layout_anchorGravity}</code></td><td>Specifies how an object should position relative to an anchor, on both the X and Y axes,
     * within its parent's bounds.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_behavior course.examples.Fragments.DynamicLayout:layout_behavior}</code></td><td>The class name of a Behavior class defining special runtime behavior
     * for this child view.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_dodgeInsetEdges course.examples.Fragments.DynamicLayout:layout_dodgeInsetEdges}</code></td><td>Specifies how this view dodges the inset edges of the CoordinatorLayout.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_insetEdge course.examples.Fragments.DynamicLayout:layout_insetEdge}</code></td><td>Specifies how this view insets the CoordinatorLayout and make some other views
     * dodge it.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_keyline course.examples.Fragments.DynamicLayout:layout_keyline}</code></td><td>The index of a keyline this view should position relative to.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name course.examples.Fragments.DynamicLayout:layout_anchor
     */
     ...
     * </table>
     *
     * @attr name course.examples.Fragments.DynamicLayout:layout_anchorGravity
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name course.examples.Fragments.DynamicLayout:layout_behavior
     */
     ...
     * </table>
     *
     * @attr name course.examples.Fragments.DynamicLayout:layout_dodgeInsetEdges
     */
     ...
     * </table>
     *
     * @attr name course.examples.Fragments.DynamicLayout:layout_insetEdge
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name course.examples.Fragments.DynamicLayout:layout_keyline
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority course.examples.Fragments.DynamicLayout:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts course.examples.Fragments.DynamicLayout:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy course.examples.Fragments.DynamicLayout:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout course.examples.Fragments.DynamicLayout:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage course.examples.Fragments.DynamicLayout:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery course.examples.Fragments.DynamicLayout:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name course.examples.Fragments.DynamicLayout:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name course.examples.Fragments.DynamicLayout:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name course.examples.Fragments.DynamicLayout:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name course.examples.Fragments.DynamicLayout:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name course.examples.Fragments.DynamicLayout:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name course.examples.Fragments.DynamicLayout:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font course.examples.Fragments.DynamicLayout:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle course.examples.Fragments.DynamicLayout:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings course.examples.Fragments.DynamicLayout:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight course.examples.Fragments.DynamicLayout:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex course.examples.Fragments.DynamicLayout:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name course.examples.Fragments.DynamicLayout:font
     */
     ...
     * </table>
     *
     * @attr name course.examples.Fragments.DynamicLayout:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name course.examples.Fragments.DynamicLayout:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name course.examples.Fragments.DynamicLayout:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name course.examples.Fragments.DynamicLayout:ttcIndex
     */
